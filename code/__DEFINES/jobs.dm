...
#define JOB_CIVIL_RANK_LEADER "Civil Rank Leader"
#define JOB_DISPLAY_ORDER_CIVIL_RANK_LEADER 36
...
#define DEPARTMENT_BITFLAG_ENGINEER_CORE (1<<14)
#define DEPARTMENT_ENGINEER_CORE "EngineerCore"
#define DEPARTMENT_BITFLAG_CITIZENS (1<<15)
